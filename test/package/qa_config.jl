...
const QA_CONFIG = (
    ...
    # non-publicly. `read` (CSV) and `PriorLike` (ComposableTuringIDModels)
    # are not exported upstream but are part of those packages' public API in
    # practice.
    ei_ignore = (:read, :PriorLike),
